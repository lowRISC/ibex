...
module prim_alert_rxtx_assert_fpv (
  ...
  `ASSERT(PingHs_A,
          ##1 $changed(
              prim_alert_rxtx_fpv.alert_rx_out.ping_p
  ...
  `ASSERT(AlertPingOk_A,
          !(prim_alert_rxtx_fpv.i_prim_alert_sender.state_q inside {
      prim_alert_rxtx_fpv.i_prim_alert_sender.PingHsPhase1,
      prim_alert_rxtx_fpv.i_prim_alert_sender.PingHsPhase2}) && $rose(
              ping_req_i
          ) |-> ##[1:9] ping_ok_o,
          clk_i, !rst_ni || error_present)
  ...
  `ASSERT(AlertCheck0_A,
          !ping_req_i [* 3] ##0 $rose(
              alert_req_i
                ...
                prim_alert_rxtx_fpv.i_prim_alert_sender.Idle) |=> alert_o,
          clk_i, !rst_ni || error_present || ping_req_i)
