...
#ifndef SIMPLE_SYSTEM_COMMON_IBEX_REGISTERS_H_
#define SIMPLE_SYSTEM_COMMON_IBEX_REGISTERS_H_

#define CSR_READ(csr, dest)                                    \
  do {                                                         \
    _Static_assert(sizeof(*dest) == sizeof(uint32_t),          \
...
#define CSR_WRITE(csr, val)                            \
  do {                                                 \
    _Static_assert(sizeof(val) == sizeof(uint32_t),    \
...
#endif  // SIMPLE_SYSTEM_COMMON_IBEX_REGISTERS_H_
