...
#ifndef SIMPLE_SYSTEM_COMMON_PMP_H_
#define SIMPLE_SYSTEM_COMMON_PMP_H_
...
pmp_result_t pmp_region_configure_na4(pmp_region_index_t region,
                                      const pmp_region_config_t config,
                                      uintptr_t address);
 ...
 */
PMP_WARN_UNUSED_RESULT
pmp_result_t pmp_region_lock_status_get(pmp_region_index_t region,
                                        pmp_region_lock_t *lock);

#endif  // SIMPLE_SYSTEM_COMMON_PMP_H_
