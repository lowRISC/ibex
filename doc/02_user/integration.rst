...
+------------------------------+---------------------+-------------+-----------------------------------------------------------------------+
| ``RV32ZC``                   | ibex_pkg::rv32zc_e  | RV32ZcbZcmp | Zc code-size saving extension select:                                 |
|                              |                     |             | "ibex_pkg::RV32ZcNone": No Zc-extensions                              |
|                              |                     |             | "ibex_pkg::RV32Zcb": Zcb extension only                               |
|                              |                     |             | "ibex_pkg::RV32Zcmp": Zcmp extension only                             |
|                              |                     |             | "ibex_pkg::RV32ZcbZcmp": Both Zcb and Zcmp extensions                 |
+------------------------------+---------------------+-------------+-----------------------------------------------------------------------+
