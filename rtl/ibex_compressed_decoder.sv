...
module ibex_compressed_decoder #(
  parameter ibex_pkg::rv32zc_e RV32ZC = ibex_pkg::RV32ZcbZcmp
) (
  input  logic                 clk_i,
  input  logic                 rst_ni,
  input  logic                 valid_i,
    ...
    unique case (instr_i[1:0])
      ...
      2'b00: begin
        unique case (instr_i[15:13])
          ...
          3'b100: begin // loads and stores
            if (RV32ZC == RV32ZcbZcmp || RV32ZC == RV32Zcb) begin
      ...
      2'b10: begin
        unique case (instr_i[15:13])
          ...
          3'b101: begin
            if (RV32ZC == RV32ZcbZcmp || RV32ZC == RV32Zcmp) begin
                  ...
                  unique case (cm_state_q)
                    CmIdle: begin
                      ...
                      if (cm_rlist_d <= 5'd3) begin
                        ...
                        cm_rlist_d -= 5'd1;
                        // Initialize SP offset to 2. We just stored at offset 1 this cycle and will
                        // start incrementing the offset from 2 onwards in CmPushStoreReg next cycle.
                        cm_sp_offset_d = 5'd2;
